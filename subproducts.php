...
// --- CONFIGURATION ---
$page_nm = "Sub Products";
$table = "tbl_subproducts";
$redirection_url = "subproducts.php";
        ...
        <?php if ($mode == 'list'): ?>
            <div class="d-md-flex d-block align-items-center justify-content-between mb-4">
                ...
                <div class="mb-2 d-flex gap-2">
                    ...
                    <a href="subproducts.php?mode=add" class="btn btn-primary d-flex align-items-center shadow-sm">
                        <i class="ti ti-plus me-2"></i>Create Sub Product
                    </a>
                </div>
            </div>
            ...
            <div class="collapse mb-4" id="filterCollapse">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-3">
                        <form action="subproducts.php" method="GET" class="row g-3">
                            ...
                            <div class="col-md-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="search" class="form-control border-start-0"
                                        ...
                                        placeholder="Search Sub Product Name...">
                                </div>
                            </div>
                            <div class="col-md-2">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom-0 py-3">
                    <h5 class="card-title mb-0">Sub Product Directory</h5>
                </div>
                                                ...
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end shadow border-0">
                                                        <a class="dropdown-item py-2"
                                                            href="subproducts.php?mode=edit&id=<?php echo $row->id; ?>"><i
                                                                class="ti ti-edit me-2 text-info"></i> Edit</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item py-2 text-danger"
                                                            href="subproducts.php?mode=delete&id=<?php echo $row->id; ?>"
            ...
            <div class="form-header-bar">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="subproducts.php">Masters</a></li>
                        <li class="breadcrumb-item active">
                            <?php echo $mode == 'add' ? 'Create Sub Product' : 'Edit Sub Product'; ?>
                        </li>
                    </ol>
                </nav>
                <a href="subproducts.php" class="btn-back-standard">
                    <i class="ti ti-chevrons-left"></i> Back
                </a>
            </div>

            <form action="subproducts.php" method="POST" class="needs-validation" novalidate>
                ...
                <div class="form-card-standard">
                    <div class="row g-3">
                        <div class="col-md-4">
                            <label class="form-label fw-bold">Sub Product Name <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <input type="text" name="name" class="form-control border-start-0"
                                    value="<?php echo $data->name ?? ''; ?>" placeholder="Enter Sub Product Name" required>
                                <div class="invalid-feedback">Please enter a Sub Product name.</div>
                            </div>
                        </div>
                    ...
                    <div class="form-action-btns mt-4">
                        <button type="submit" name="btn_submit" class="btn-submit-standard px-5">
                            <i
                                class="ti ti-device-floppy me-2"></i><?php echo $mode == 'add' ? 'Save Subproduct' : 'Update Changes'; ?>
                        </button>
                        <a href="subproducts.php" class="btn-cancel-standard px-5">
                            Cancel
                        </a>
                    </div>
                </div>
