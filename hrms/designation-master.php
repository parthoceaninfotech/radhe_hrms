<?php
$pageTitle = "Designation Master - Payroll System";
include 'header.php';
?>
...
<div class="container-fluid flex-grow-1 container-p-y position-relative" style="min-height: calc(100vh - 120px);">
  ...
  <div id="draggableCard" class="card shadow-lg border-1"
    style="max-width: 750px; width: 100%; border-radius: 8px !important; border: 1px solid #c9c8cc !important; background-color: #ffffff; position: absolute; opacity: 0; transition: opacity 0.15s ease-in-out; z-index: 1;">
      ...
      <form id="designationMasterForm">
        ...
        <fieldset class="border p-3 rounded mb-2" style="border-color: #a3b8cc !important;">
          <legend class="float-none w-auto px-2 fw-bold text-primary" style="font-size: 12px; margin-bottom: 0;">
            Designation Details</legend>

          <!-- Nav Tabs styled classically -->
          <ul class="nav nav-tabs mb-0 border-bottom-0" id="desigTabs" role="tablist"
            style="margin-left: 0 !important; margin-right: 0 !important; padding-left: 4px !important;">
            <li class="nav-item" role="presentation">
              <button class="nav-link active fw-bold py-1 px-3" id="desig-tab" data-bs-toggle="tab"
                data-bs-target="#desig-info" type="button" role="tab" aria-controls="desig-info" aria-selected="true"
                style="font-size: 11px;">Designation Information</button>
            </li>
          </ul>

          <!-- Tab Content Container with light blue background and border -->
          <div class="tab-content border p-3 rounded-bottom bg-legacy-blue" id="desigTabsContent"
            style="min-height: 150px;">
            <div class="tab-pane fade show active" id="desig-info" role="tabpanel" aria-labelledby="desig-tab">
              <div class="row g-3 py-2">
                <div class="col-12">
                  <div class="row mb-2 align-items-center">
                    <label class="col-sm-2 col-form-label col-form-label-sm text-end fw-semibold text-dark-blue"
                      style="font-size: 11px;">Desig. Id.</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control form-control-sm bg-white" name="desig_id" id="desig_id"
                        value="1355" style="font-size: 11px;" />
                    </div>
                  </div>

                  <div class="row mb-2 align-items-center">
                    <label class="col-sm-2 col-form-label col-form-label-sm text-end fw-semibold text-dark-blue"
                      style="font-size: 11px;">Desig. Description</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control form-control-sm bg-white" name="desig_desc" id="desig_desc"
                        value="CARE TAKER" style="font-size: 11px;" />
                    </div>
                  </div>
                </div>
              </div>
...
<style>
  ...
  #desigTabs .nav-item .nav-link:hover {
    background-color: #e3ebf6 !important;
    color: #135ca3 !important;
  }

  #desigTabs .nav-item .nav-link.active {
    background-color: #e8f0fe !important;
    border-color: #a3b8cc !important;
