...
$data = $ai_db->aiGetQueryObj("SELECT * FROM tbl_factory_renewals WHERE id='$id' LIMIT 1")[0] ?? null;

if (!$data) {
    echo "Renewal record not found";
    exit;
}
...
// Use created_at as quotation reference date, fall back to current date if invalid
$qtn_date_raw = (!empty($data->created_at) && $data->created_at != '0000-00-00 00:00:00') ? $data->created_at : date('Y-m-d H:i:s');
$qtn_year = date('Y', strtotime($qtn_date_raw));
$qtn_no = "RAD/QTN/" . $qtn_year . "/" . str_pad($data->id, 4, '0', STR_PAD_LEFT);
...
<head>
    ...
    <title>Renewal Quotation - <?php echo $data->company_name; ?></title>
    <style>
        @page {
            size: A4;
            margin: 0;
            ...
            <table class="info-grid">
                <tr>
                    ...
                    <td class="info-box">
                        ...
                        <span class="value"><?php echo date('d/m/Y', strtotime($qtn_date_raw)); ?></span>
                    </td>
                </tr>
                <tr>
                    <td class="info-box">
                    ...
                    <td class="info-box">
                        ...
                        <span class="value"><?php echo $qtn_no; ?></span>
                    </td>
                </tr>
            </table>
            ...
            <table class="items-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="font-weight: bold;">Factory License Renewal Fees</td>
                        <td style="text-align: center;"><?php echo $data->num_workers ?: '-'; ?></td>
                        <td style="text-align: center;">
                            <?php echo $data->horse_power ? $data->horse_power . ' HP' : '-'; ?>
                        </td>
