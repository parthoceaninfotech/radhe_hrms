...
// --- CONFIGURATION ---
$page_nm = "Medical Covers";
$table = "tbl_medical_covers";
$redirection_url = "medical_covers.php";
...
if (isset($_POST['btn_submit'])) {
    ...
    if ($mode === "add") {
        $sql = "INSERT INTO $table SET name='$name', insurance_type='$insurance_type', status='$status'";
        $msg = 1;
    } else {
        $sql = "UPDATE $table SET name='$name', insurance_type='$insurance_type', status='$status' WHERE id='$id'";
        $msg = 2;
    }
        ...
        <?php if ($mode == 'list'): ?>
            <div class="d-md-flex d-block align-items-center justify-content-between mb-4">
                ...
                <div class="mb-2 d-flex gap-2">
                    ...
                    <a href="medical_covers.php?mode=add" class="btn btn-primary d-flex align-items-center shadow-sm">
                        <i class="ti ti-plus me-2"></i>Create Medical Cover
                    </a>
                </div>
            </div>
            ...
            <div class="collapse mb-4" id="filterCollapse">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-3">
                        <form action="medical_covers.php" method="GET" class="row g-3">
                            ...
                            <div class="col-md-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="search" class="form-control border-start-0"
                                        ...
                                        placeholder="Search medical cover name...">
                                </div>
                            </div>
                            <div class="col-md-2">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom-0 py-3">
                    <h5 class="card-title mb-0">Medical Cover Directory</h5>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-soft-info text-info">
                                                    <?php echo strtoupper($row->insurance_type ?: 'All'); ?>
                                                </span>
                                            </td>
                                                ...
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end shadow border-0">
                                                        <a class="dropdown-item py-2"
                                                            href="medical_covers.php?mode=edit&id=<?php echo $row->id; ?>"><i
                                                                class="ti ti-edit me-2 text-info"></i> Edit</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item py-2 text-danger"
                                                            href="medical_covers.php?mode=delete&id=<?php echo $row->id; ?>"
            ...
            <div class="form-header-bar">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="medical_covers.php">Masters</a></li>
                        <li class="breadcrumb-item active">
                            <?php echo $mode == 'add' ? 'Create Medical Cover' : 'Edit Medical Cover'; ?>
                        </li>
                    </ol>
                </nav>
                <a href="medical_covers.php" class="btn-back-standard">
                    <i class="ti ti-chevrons-left"></i> Back
                </a>
            </div>

            <form action="medical_covers.php" method="POST" class="needs-validation" novalidate>
                ...
                <div class="form-card-standard">
                    <div class="row g-3">
                        <div class="col-md-4">
                            <label class="form-label fw-bold">Medical Cover Name <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <input type="text" name="name" class="form-control border-start-0"
                                    value="<?php echo $data->name ?? ''; ?>" placeholder="Enter medical cover name"
                                    required>
                                <div class="invalid-feedback">Please enter a medical cover name.</div>
                            </div>
                        </div>

                        <div class="col-md-4">
                            <label class="form-label fw-bold">Insurance Type</label>
                            <select name="insurance_type" class="form-select border-start-0">
                                <option value="">Select Insurance Type</option>
                                <option value="ecp" <?php echo ($data && $data->insurance_type == 'ecp') ? 'selected' : ''; ?>>ECP</option>
                                <option value="health" <?php echo ($data && $data->insurance_type == 'health') ? 'selected' : ''; ?>>Health</option>
                                <option value="fire" <?php echo ($data && $data->insurance_type == 'fire') ? 'selected' : ''; ?>>Fire</option>
                                <option value="vehicle" <?php echo ($data && $data->insurance_type == 'vehicle') ? 'selected' : ''; ?>>Vehicle</option>
                                <option value="life" <?php echo ($data && $data->insurance_type == 'life') ? 'selected' : ''; ?>>Life</option>
                            </select>
                        </div>
                    ...
                    <div class="form-action-btns mt-4">
                        <button type="submit" name="btn_submit" class="btn-submit-standard px-5">
                            <i
                                class="ti ti-device-floppy me-2"></i><?php echo $mode == 'add' ? 'Save Medical Cover' : 'Update Changes'; ?>
                        </button>
                        <a href="medical_covers.php" class="btn-cancel-standard px-5">
                            Cancel
                        </a>
                    </div>
                </div>
